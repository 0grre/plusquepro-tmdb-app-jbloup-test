<div class="max-w-screen-xl px-4 mx-auto lg:px-12 w-full mt-12">
        ...
        <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
            ...
            <div
                ...
                <div class="flex items-center w-full space-x-3 md:w-auto">
                    ...
                    <!-- Dropdown menu -->
                    <div x-data="{ selectedGenres: @entangle('selectedGenres') }" x-init="console.log('Selected Genres:', selectedGenres)">
    ...
    <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg mt-12">
        <div
                        ...
                        <td class="px-4 py-2">
                            <ul class="text-gray-500 dark:text-gray-400">
                                @foreach($movie->genres as $genre)
                                    <li>
                                        <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ $genre->name }}</span>
                                    </li>
                                @endforeach
                            </ul>
